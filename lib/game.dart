...
import 'package:viena_kalevala_game/powerups.dart';
import 'package:viena_kalevala_game/route.dart';
import 'package:viena_kalevala_game/scroll.dart';
...
class _GameState extends State<Game> with WidgetsBindingObserver, TickerProviderStateMixin {
  ...
  static String skyAsset() => "background/kalevala.png";

  static String stageAsset() => "background/bear.png";

...
//
  ...
  Future<void> incrementPoints() async {
    ...
    bool firstTime = globals.firstTime;

    setState(() {
      _name =
          prefs.setString("userName", globals.userName).then((bool success) {
        return name;
      });
      _points =
          prefs.setInt("points", globals.totalPoints).then((bool success) {
        return points;
      });
      _firstTime =
          prefs.setBool("firstTime", globals.firstTime).then((bool success) {
        return firstTime;
      });
    });
    return -1;
...
//                   color: jadeColor,
//                   backgroundColor: Colors.transparent,
//                   fontSize: MediaQuery.of(context).size.width / 15 <= 50.0
...
//                   color: blushColor,
//                   backgroundColor: Colors.transparent,
//                   fontSize: MediaQuery.of(context).size.width / 20 <= 30.0
